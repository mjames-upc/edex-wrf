...
#
#MPICH_HOME=$UEMS/util/mpich2 ; export MPICH_HOME
MPICH_HOME=/usr/lib64/mpich ; export MPICH_HOME
...
#
SOCKETS=10  ; export SOCKETS
CORES=1   ; export CORES
...
#
    ...
    STRC_BIN=$EMS_STRC/Ubin     ; export STRC_BIN
    STRC_PREP=$EMS_STRC/Uprep   ; export STRC_PREP
    STRC_RUN=$EMS_STRC/Urun     ; export STRC_RUN
    STRC_POST=$EMS_STRC/Upost   ; export STRC_POST
    STRC_AUTO=$EMS_STRC/Uauto   ; export STRC_AUTO
    STRC_UTIL=$EMS_STRC/Uutils  ; export STRC_UTIL
    ...
    RUN_BASE=$EMS_RUN             ; export RUN_BASE
    ...
    # cores * physical cpus
    #
    OMP_NUM_THREADS=$(($SOCKETS * $CORES))   ; export OMP_NUM_THREADS
...
#
PATH=".:${STRC_BIN}:${DW_BIN}:${EMS_BIN}:${EMS_UTIL}/grads/bin:${EMS_UTIL}/bin:${GADDIR}:${EMS_MPI}/bin:${EMS_UTIL}/ncview/bin:${EMS_UTIL}/HDFView/bin:${PATH}"
export PATH
